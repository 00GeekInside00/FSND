...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://nrsdyucjnfhenp:4c17438a512b2a307923e5464f2ec1ad4c677d8e3cc77a26d826673e0a677170@ec2-54-217-213-79.eu-west-1.compute.amazonaws.com:5432/d9ll3obff1cu1u" 
    ...
    def test_mailformed_quiz_request_format(self):
        data={
            	"previous_questions": [],
	            "quiz_category": {"type": "click", "id": "Your Request Is a Failure"}
        }
        res = self.client().post('/quizzes', json=data)    
        data = json.loads(res.data)                              
        self.assertEqual(res.status_code, 405)                  
